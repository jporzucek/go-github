...
// ListAppRestrictions holds a reference to ListApps so it preservers a naming convention
// with ListUserRestrictions and ListTeamRestrictions methods.
var ListAppRestrictions = (*RepositoriesService).ListApps
